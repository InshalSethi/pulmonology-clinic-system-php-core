...
include '../include/config.php';    
 if (isset($_POST['add_medicine'])) {
      ...
      for ($i=0; $i <$cou ; $i++) 
      { 
        $st_data=Array("st_name"=>$eng_prec[$i],"st_use"=>$urdu_prec[$i]);
        $db->insert('stamps',$st_data);

      }


         header("LOCATION:view_all_stamps.php");
    }
      ...
      <?php
       ...
       ?>
        <div id="page-wrapper" style="padding-top: 28px; overflow-x: hidden;">
            ...
            <h1> Add New Stamp For Medicine</h1>
          ...
          <input  class="test form-control tt fnt-family" name="urdu[]" type="text" cols="50" rows="auto" dir="rtl" style="font-weight: bold;color:black;height:40px;font-size: 14px;"></input>
          </div>
...
$(document).ready(function() {
        ...
        $('#addButton').click(function() {   
            $('.new').append("<div class='prec"+ i +" del'><div class='row'><div class='form-group col-md-6' style='padding-left: 14px; '><input name=eng[] type='text' class='form-control col-md-6 medicine' cols='50' rows='auto' style='font-weight: bold;color:black;height:auto;font-size: 18px;'></input></div><div class='form-group col-md-6'><input  class='test form-control tt fnt-family' name='urdu[]' type='text' cols='50' rows='auto' dir='rtl' style='color:black;font-weight:bold;font-size:14px;height:40px;'></input></div></div></div>");
            $('.description'+d+'').hide();
            i++;
            d++;
            myFunction();
