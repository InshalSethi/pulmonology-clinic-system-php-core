...
include '../include/config_new.php'; 
 ...
 if (isset($_POST['add_medicine'])) {
         ...
         // $a->insert('current_patient_medicine',$med_rec,null);
          ...
          $data=$a->select('review_lab','lab_test','','');
 ...
 // if the word new enter in table of word sugesstion
        if(  $flag == 0)
        {
            ...
            $a->insert('review_lab',$ins,null);

        }

        }

        header("LOCATION:view_all_prev_lab.php");
    }
...
<head>
    <meta charset="utf-8">
    <title>Doctor | Add Review Previous Lab</title>
      ...
      <?php
       ...
       ?>
        <div id="page-wrapper" style="padding-top: 28px; overflow-x: hidden;">
            ...
            <h1> Add Review of Previous Lab As Administrator </h1>
