...
if(isset($_POST['change_recored']))
{
   ...
   $update_data=Array('rec_fee'=>$dr_fee,'charity'=>$charity);

   $db->where('p_id',$pat_id);
   $db->where('checkup_id',$checkup_id);
   $db->update('current_checkup',$update_data);
    ...
    for ($i=0; $i <$cou_outdoor ; $i++) 
    {
        if ($outdoor_test[$i] != '') {
            ...
            // push_test_place($outdoor_text[$i],$db);
    ...
    $chk_tbl_data = Array('pt_proc'=>$pro_pat,'hpi'=>$hpi,'impression'=>$impression,"is_insert"=>'1','examination'=>$exam,'pat_plan'=>$pat_plan);
    $db->where('p_id',$pat_id);
    $db->where('checkup_id',$checkup_id);
    $db->update('current_checkup',$chk_tbl_data);
...
<head>
    ...
    <title>Doctor | Patient Checkup</title>
<!-- Bootstrap Core CSS -->
 <?php
 include 'lib.php';
  ...
  <div class="modal-dialog" role="document" style="min-width: 870px;">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!---->
    <h1 class="page-header" style="margin-bottom: 0px;margin-top: 22px;">Patient Checkup</h1>
    <?php
    ...
    ?>
   <!--  <div class="row">
            <button onclick="call_patient('<?php //echo $pat_id ?>',<?php //echo $checkup_id; ?>)" name="call_patient" type="button" class="btn btn-info" title="Click here to call patient in room" style="margin-left: 16px;"><i class="fa fa-phone" style="color:green;margin-right:5px;"></i>Call Patient</button>
...
<?php  $check_num++;  }
    ...
    <!--<div class="form-group">-->
    <!--<label>Age</label>-->
    <!--<input class="form-control" type="number" name="age" id="" placeholder="" value="<?php // echo $patient['age'] ?>">-->
    <!--</div>-->
    <div class="form-group">
    ...
    <div class="form-group">
         <a class="btn btn-primary btn-info-first" title="Click here to check patient basic information like S/O,D/O, Contact No. , Address">Info</a>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
         <a class="btn btn-primary btn-info" title="Click here to check BMI">BMI</a>
    </div>
    <div id="response"></div>
    <!-- BMI End -->
    <!-- blood pressure -->
    ...
    <div class="form-group hidden">
    <label>Charity</label>
    <input class="form-control" type="text" name="charity" id="charity" value=""
        id="" placeholder="" >
    </div>
    </div>
                    ...
                    <div class="card cardappoint card-topline-yellow ">
                       ...
                       <div class="card-body card-bodystyle">
                            <div action="#" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
                                ...
                                <textarea  class="textarea form-control" name="pro_pat" type="text" autocomplete="off"></textarea>
                                </div>
                                
                                <div class="form-group">
                                <label>Systemic Examination</label><br>
                                <textarea  class="textarea form-control" name="examination" type="text" autocomplete="off">S1+S2+</textarea>
                                </div>
                                <div class="form-group">
                                        <label>Diagnosis</label><br>
                                        <textarea id="impression" class="textarea form-control" name="impression" id="impression" type="text" autocomplete="off"><?php echo $checkup['impression']; ?></textarea>
                                    </div>
                                <div class="form-group">
                                <label>Plan</label><br>
                                <textarea id="pat_plan" class="textarea form-control" name="pat_plan"  type="text" autocomplete="off"></textarea>
                                </div>
                            <div class="labs-show">
                                <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control outdoor setwid" name="outdoor_test[]"  autocomplete="off" placeholder="example:Blood Test"/>
                                         ...
                                         <div class="col-md-5 setpad">
                                        <input class="form-control setwid test-place " name="outdoor_text[]"  autocomplete="off" placeholder="Test Detail"/>
                                        </div>
                            ...
                            <div class="form-group">
                                <a class="btn btn-primary btn-labs" title="Click here to add lab test (Inhouse And Outside)">Lab Tests</a>
                            </div>
                ...
                <div class="form-group text-center">
                 <button type="submit" name="change_recored" class="btn btn-success" title="Clcik here to save this patient record and proceed to next page for Medicine Insertion">Save</button>
                </div>
            </form>
        </div>
...
<script src="bmi.js"></script>
  <script src="back.js"></script>
    ...
    $(".new_lab1").append("<div class='lab1'><div class='col-md-1 setpad set_btnwid make-mar'></div><div class='col-md-5 setpad'><input class='form-control setwid outdoor add_mar' name='outdoor_test[]' type='text' autocomplete='off' placeholder='example:Blood Test'></div><div class='col-md-5 setpad'><input class='form-control setwid add_mar test-place' name='outdoor_text[]' id='outdoor_text' type='text' autocomplete='off' placeholder='Test Detail'></div></div> ");
    autocompletelab();
    ...
    <script>
     ...
     function call_patient(pat_id,check_id){
       
         $.ajax({
        type:'POST',
        url:'ajax_patient_call.php', 
        data:{ patient_id :pat_id,checkup_id:check_id},
        success:function(){
