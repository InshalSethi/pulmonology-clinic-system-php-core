...
$ab=$a->select('medicine_suggestion','*',"medi_name='".$value."'",'');
 while($data=$ab->fetch_array())
 {
    ...
    <?php
       ...
       <a class="dropdown-item show"  onclick='fill("<?php echo  $content; ?>","<?php echo  $id_class; ?>")' style="text-align:right;font-size: 17px;font-weight: 600;font-family: 'Noto Nastaliq Urdu Draft', serif;" >  <?php echo $content; ?> </a>  
