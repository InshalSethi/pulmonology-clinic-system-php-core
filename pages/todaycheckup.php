...
<head>
    ...
    <title>Doctor | Today Checkups</title>
    ...
    <div class="container-fluid">
       ...
       ?>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Today Checkups</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $db->join("total_checkup tc", "tc.p_id=tp.p_id", "LEFT");
                                             $db->where('is_delete','0');
                                            $db->where ('tc.checkup_date',$today_date);
                                            
                                            $pat_data = $db->get ("total_patient tp", null, "tp.p_id, tp.p_name ,tp.contact,tp.address");
