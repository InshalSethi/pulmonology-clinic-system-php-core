    ...
    <div class="container-fluid">
       ...
       ?>
            ...
            <div id="page-wrapper">
                ...
                <!-- /.row ////-->
                <button class="btn btn-primary" onclick="window.location.href='add_plan.php'">Add Plan</button>
                <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php echo $plan['plan_name']; ?>
                                               ...
                                               <td>
                                                ...
                                                <a class="btn btn-danger btn-circle" onclick="myFunction('<?php echo $plan['plan_id']; ?>' )" ><i class="fa fa-trash-o"></i> </a></div>
                                                </td>
                                            </tr>
                                            <?php $i++;  } 
                                          ?>
...
window.location = "view_all_plan.php?id="+clicked_id; 
