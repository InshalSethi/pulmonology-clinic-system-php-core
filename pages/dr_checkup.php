...
if(isset($_POST['change_recored']))
{
   ...
   $db->update('current_checkup',$update_data);
    ...
    { 
        ...
        push_review_lab($review_lab[$i],$db);
...
//    echo "---------".$final_text_tab;
    ...
    push_med_suggestion($review_med[$i],$db);
    ...
    $pat_tbl_data = Array('past_history'=>$past_history,'f_history'=>$family_history,'per_history'=>$per_history,'review_pre_lab'=>$final_text_tab,'review_pre_med'=>$final_text);
    $db->where('p_id',$pat_id);
    $db->update('current_patient',$pat_tbl_data);
...
<body>
    ...
    <div id="wrapper">
        ...
        ?>
           ...
           <!--  <button onclick="call_patient('<?php // echo $pat_id ?>',<?php // echo $checkup_id; ?>)" name="call_patient" type="button" class="btn btn-info" title="Click here to call patient in room"><i class="fa fa-phone" style="color:green;margin-right:5px;"></i>Call Patient</button> -->
                    ...
                    <div class="card cardappoint card-topline-yellow ">
                       ...
                       <div class="card-body card-bodystyle">
                            <div action="#" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    <a class="btn btn-primary btn-history">History</a>
                                </div>
                                ...
                                <textarea id="impression" class="textarea form-control" name="impression"  type="text" autocomplete="off"></textarea>
                                </div>
