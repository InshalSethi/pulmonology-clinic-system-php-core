...
{  
    ...
    $ins_data=array("smoke_his"=>$smoke,"sr_name"=>$sr_name,"p_name"=>$name,"contact"=>$contact,"address"=>$address,"gender"=>$gender,"age"=>$age,"spo_rest"=>$spo2_rest,"spo_exertion"=>$spo2_exertion,"pulse_rate"=>$pulse_rate,"p_weight"=>$weight,"p_height"=>$height,"bmi"=>$bmi,"weight_sit"=>$we_situation,"co_morbidities"=>$co_morbidities,"occupation"=>$occupation,"tb_att"=>$ho_tb,"bp"=>$bp,"past_history"=>$past_history,"f_history"=>$family_history,"per_history"=>$per_history,"review_pre_lab"=>$review_lab,"review_pre_med"=>$review_med,'spo_6mwt'=>$spo2_6mwt,'spo_6mwd'=>$spo2_6mwd);
                            ...
                            <div action="#" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
                                ...
                                <div class="history-show">
                                    <div class="form-group">
                                        ...
                                        <!-- input class="textarea"  id="hpi" name="hpi" value="<?php // echo $a['hpi'];?>" contenteditable="true" / -->
                                    ...
                                    <div class="form-group">
                                        <label>Past History </label>
                                            <div class="listening" id="listening2">  Listening </div><br>
                                          <div>
                                            <span id="interim_spana" class="interima"></span>
                                        </div>
                                        
                                        <!--input class="textarea" name="past_history" value="<?php // echo $a['past_history'];?>" contenteditable="true" /-->
                                            <div class="input-group">
                                         <textarea  id="hpia" class="textarea form-control" name="past_history" contenteditable="true"><?php echo $patient['past_history'];?></textarea>
                                        <span class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        <label>Family History </label>
                                         ...
                                         <br>
                                        <!-- input class="textarea" name="family_history" value="<?php // echo $a['f_history'];?>" contenteditable="true"/ -->
                                         <div>
                                            <span id="interim_spana_fam" class="interima"></span> 
                                        </div>
                                         <div class="input-group">
                                        <textarea id="family_history" class="textarea form-control" name="family_history" contenteditable="true" ><?php echo $patient['f_history'];?></textarea>
                                         <span class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- input class="textarea" name="per_history" value="<?php // echo $a['per_history'];?>" contenteditable="true"/ -->
                                           <div class="input-group">
                                        <textarea id="per_history" class="textarea form-control" name="per_history" contenteditable="true"><?php echo $patient['per_history'];?></textarea>
                                        <span class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="textarea" name="rev_pre_lab" value="<?php echo $patient['review_pre_lab'];?>" contenteditable="true"
                                        />
                                    </div>
                                    <div class="form-group">
                                        <label>Review of Previous Medication (If Any) </label><br>
                                         <input class="textarea" name="rev_pre_med" id="rev_pre_med" value="<?php echo $patient['review_pre_med'];?>" type="text" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
