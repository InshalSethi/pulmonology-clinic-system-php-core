...
include '../include/config.php'; 
 ...
 if (isset($_POST['add_medicine'])) {
        ...
        if(  $flag == 0)
        {
            $ins_med=array('medi_name'=>$eng_prec[$i]);
            $last_med_id=$db->insert('medicine_suggestion',$ins_med);
            
            
            $in_med_des=array("med_id"=>$last_med_id,"description"=>$urdu_prec[$i]);
            $db->insert('medicine_description',$in_med_des);
      ...
      <?php
       ...
       ?>
        <div id="page-wrapper" style="padding-top: 28px; overflow-x: hidden;">
            ...
            <h1> Add New Medicine As Administrator </h1>
