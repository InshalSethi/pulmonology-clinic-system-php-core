...
include '../include/config_new.php'; 
 ...
 // if the word new enter in table of word sugesstion
        ...
        header("LOCATION:view_all_prev_med.php");
    }
...
<head>
    <meta charset="utf-8">
    <title>Doctor | Add Review Previous Medication</title>
      ...
      <?php
       ...
       ?>
        <div id="page-wrapper" style="padding-top: 28px; overflow-x: hidden;">
            ...
            <h1> Add Review of Previous Medication As Administrator </h1>
